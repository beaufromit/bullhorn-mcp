...
Usage (from repo root):
    .venv/bin/python scripts/meta_dump.py <Entity> [field-filter]

Examples:
    .venv/bin/python scripts/meta_dump.py Candidate
    .venv/bin/python scripts/meta_dump.py ClientContact title
    .venv/bin/python scripts/meta_dump.py Placement custom
