...
- Owner names containing an apostrophe (e.g. "Conor O'Reilly") shall resolve like any other name. The MCP escapes the apostrophe in the CorporateUser lookup rather than rejecting the name. Delivered (CR39).
...
Email claims containing an apostrophe (valid in email addresses) shall resolve like any other email. The MCP escapes the apostrophe in the CorporateUser lookup rather than rejecting the claim. Delivered (CR39).
